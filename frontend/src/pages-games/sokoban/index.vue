...
import { playSokobanSound, setSokobanSoundEnabled, sokobanSoundEnabled } from '@/pages-games/utils/sokobanSound'
import { DIR_NAMES, parseLevel, starsFor } from '@/pages-games/utils/sokoban'
import { CHAPTERS, LEVELS, LEVELS_PER_CHAPTER, chapterOf } from '@/pages-games/utils/sokobanLevels'
import type { SokobanLevelDef, SokobanState } from '@/pages-games/utils/sokoban'
...
onShareAppMessage(() => ({
  ...
  path: '/pages-games/sokoban/index',
}))
